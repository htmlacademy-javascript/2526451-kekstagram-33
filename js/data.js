...
const namesArray = [
  'Василий', 'Кирилл', 'Иван', 'Егор', 'Федор', 'Роман', 'Глеб', 'Григорий', 'Елисей', 'Захар', 'Николай',
  'Петр', 'Прохор', 'Савелий', 'Эдуард', 'Евгений', 'Игорь', 'Олег', 'Денис', 'Вячеслав', 'Станислав',
  'Всеволод', 'Леонид', 'Савва', 'Степан', 'Архип'];
...
function getCommentsArray () {
  const commentArray = Array.from({length: getRandomInteger(1, MAX_COMMENTS_PER_PHOTO)},createComment);
...
const photoDataArray = Array.from({length: NUMBER_OF_PHOTOS},createUserPhoto);
